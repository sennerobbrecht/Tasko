    ...
    <View style={styles.screen}>
      <View style={styles.content}>
        ...
        <View style={styles.form}>
          ...
          <Field label="Wachtwoord" placeholder="Voer je wachtwoord in" icon="🔒" trailingIcon="◔" secureTextEntry />
...
function Field({ label, placeholder, icon, trailingIcon, secureTextEntry }: FieldProps) {
  return (
    <View style={styles.fieldGroup}>
      <Text style={styles.fieldLabel}>{label}</Text>
      <View style={styles.inputShell}>
        <Text style={styles.fieldIcon}>{icon}</Text>
        <TextInput placeholder={placeholder} placeholderTextColor="#B8C7D4" secureTextEntry={secureTextEntry} style={styles.input} />
